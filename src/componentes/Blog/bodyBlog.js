                        ...
                        <div class="p-r-10 p-r-0-sr991">
                            <div class="p-b-70">
                                ...
                                <div class="wrap-pic-max-w p-b-30">
                                    <img src={require("../../assets/images/blog-list-01.jpg")} alt="IMG"/>
                                </div>
                                ...
                                <ul class="p-t-35">
                                    <li class="flex-wr-sb-s p-b-30">
                                        <a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
                                            <img src={require("../../assets/images/popular-post-04.jpg")} alt="IMG"/>
                                        </a>
                                    ...
                                    <li class="flex-wr-sb-s p-b-30">
                                        <a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
                                            <img src={require("../../assets/images/popular-post-05.jpg")} alt="IMG"/>
                                        </a>
                                    ...
                                    <li class="flex-wr-sb-s p-b-30">
                                        <a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
                                            <img src={require("../../assets/images/popular-post-06.jpg")} alt="IMG"/>
                                        </a>
